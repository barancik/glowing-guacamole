...
from the reference sentence and all sequences from the hypothesis. \diff{In contrast to $C_{L}$,
...
\todo{vleky priklad vseho}
\begin{figure}[t]

\begin{center}
\begin{tabular}{ll}
 Source sentence &  \begin{tabular}{l}
 ...
 \hline  
   $C_{M} $  & {(už, samotné místo), (už, samotné místo je),
...
$C_{M} $ - 84 possibilities, mostly omitted}
