...
Furthermore, its complicated. Consider the following example from WMT15 Russian to English task. A sentence ... was translated differently by all 14 competing systems.   -- imagine comparing the following sentences: \todo{tu by to chtelo priklad - co je horsi nesmyslna veta, neprelozene slovo...}
...
What is worse -- non-sensical sentence, untranslated words, grammatical errors,...? 

\todo{There are no exact methodology how to evaluate... ze to kazdy citi jinak, souteze to nemaji, CCB}

\todo{And after seeing several such a bad translations and making the difficult choice in their comparison, it is literally impossible to remember its own choices which causes also low intra-annotator agreement}
%Moreover, it is practically impossible to repeat the evaluation with the same results \cite{bojar-kniha}. 
\todo{updatovat citace}
This complexity of translation evaluation causes low inter-annotator agreement \cite{wmt13}. 
...
However, it has also its disadvantages. It is slow and expensive \todo{podporit tvrzeni}, 
...
intrannotator agreement \todo{odkaz}.
...
%, counting a~number of necessary post-edits to a correct translation or 
...
developed by the Linguistics Data Consortium \todo{(LDC,2005)},  a human judge 
