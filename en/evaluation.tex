...
Since the very first appearance of machine translation (MT) systems, a necessity for their objective evaluation and comparison has emerged. Traditional direct evaluation slowly became unfeasable for vyhodnocovani postupneho zlepsovani prekladovych systemu \todo{vycizelovat}
...
All these intricacies involved in translation evaluation lead to low inter-annotator agreement \cite{wmt13}. \todo{updatovat citace}
