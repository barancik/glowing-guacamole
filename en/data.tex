...
We therefore attempt to automatically filter the Meteor table. \todo{tu to zacina byt komplikovany, je to potreba nejak spojit s tou kapitolou o parafrazovani} the methods are described in Section \ref{filtering-section}
